...
export default function ProductsByBrand() {
     const [selectBrand, setSelectBrand] = useState('Apple');
     const [products, setProducts] = useState(json);
      ...
      return (
        <div className="flex flex-col items-center max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
            <h2 className="text-gray-500 font-bold text-4xl mb-10 mt-20">Veja todos nossos produtos Apple</h2>
            ...
            <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8 ">
                ...
                {products.map((product) => (
                    ...
                    <p className="mt-1 mb-10 text-xl font-medium text-gray-900">Marca: {product.brand}</p>
                    <SeeMore item={product.id} />
                </div> : ''
                ))}
            </div>

            <h2 className="text-gray-500 font-bold text-4xl mb-10 mt-20">Veja todos nossos produtos Xiaomi</h2>
           ...
           <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8 ">
            ...
            <h2 className="text-gray-500 font-bold text-4xl mb-10 mt-20">Veja nossos Acessórios</h2>
           
           <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8 ">
               
               {products.map((product) => (
                   product.brand === 'Accesorios' ? 
                   <div key={product.id} className="group flex flex-col justify-between p-4">
                   <div className="w-50 h-50 bg-indigo-700 aspect-w-1 aspect-h-1 bg-gray-200 rounded-lg overflow-hidden xl:aspect-w-7 xl:aspect-h-8">
            ...
            <h2 className="text-gray-500 font-bold text-4xl mb-10 mt-20">Veja nosso acessorios para TV</h2>
